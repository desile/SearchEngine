...
/**
 * Created by desile on 03.03.17.
 */
public class Constants {

    public static String WIKIDUMP_DIR = "/home/desile/wikidump/";
    ...
    public static String DOCS_TITLES_PATH = Constants.WIKIDUMP_DIR + "docsTitles";
